...
- **Part (a)**  
  Defined:  
  - **Allocational harm** → unfair denial of opportunities/resources  
  - **Representational harm** → disrespect, stereotypes, biased portrayal
...
- **Part (a)**  
  ...
  - **Annotation bias** (labelers’ assumptions)
...
- **Part (c)**  
  I explained **bias amplification**, where models exaggerate existing bias during training — even after preprocessing.
...
- **Part (c)**  
  I explained how **model stealing** threatens privacy and intellectual property by copying a model’s functionality through repeated queries.
...
- **Part (a)**  
  ...
  - Technical → fairness-aware training methods  
  - Non-technical → stakeholder review & impact assessment
